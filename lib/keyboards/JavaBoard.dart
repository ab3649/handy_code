...
class JavaKeyboard extends StatelessWidget {
  final TextEditingController textEditingController;

  JavaKeyboard({required this.textEditingController});
...
class JavaKeyboardExample extends StatefulWidget {
  @override
  _JavaKeyboardExampleState createState() => _JavaKeyboardExampleState();
}

class _JavaKeyboardExampleState extends State<JavaKeyboardExample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
          child: JavaKeyboard(textEditingController: _textEditingController)),
    );
  }
}